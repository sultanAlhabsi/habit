...
1. **استئصال الـ Deadlock بفصل الواجهة العامة عن التنفيذ الداخلي (Internal Execution Decoupling):** إن تغليف دوال الاستعلام بطابور تسلسلي يقتضي قاعدة معمارية صارمة: لا يجوز لأي دالة داخلية مستدعاة ضمن الطابور أن تطلب الانضمام لنفس الطابور مرة أخرى. تم حل المعضلة بتخصيص الدوال الداخلية `*Internal` التي تتسلم كائن قاعدة البيانات المباشر، تاركة مسؤولية المزامنة للطبقة الخارجية حصراً.
2. **التذكير المسائي كأداة تحفيز واستبقاء (Habit Formation Evening Loop):** تؤكد دراسات علم النفس السلوكي أن المراجعة المسائية الهادئة هي الحافز الأكبر لتثبيت العادات وتدوين الخواطر، لذا تم تصميمه كخيار مستقل وسلس يمكن تفعيله وتحديد موعده بدقة دون إرباك تنبيهات العادات الفردية المجدولة نهاراً.
