...
export const HomeScreen: React.FC<HomeScreenProps> = ({ navigation }) => {
  ...
  // Memoized expensive derived stats
  ...
  const sortedFilteredHabits = useMemo(() => {
    return sortHabits(filteredHabits, sortOption, checkins, selectedDate);
  ...
  const sortedOffScheduleHabits = useMemo(() => {
    return sortHabits(filteredOffScheduleHabits, sortOption, checkins, selectedDate);
